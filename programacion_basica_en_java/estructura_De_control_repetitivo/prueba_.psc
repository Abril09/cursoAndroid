//programa principal tipo menú en el cual se realizará llamada a cada función que
//realizará tareas independientes.
...
Funcion ejercicio_7()
	...
	Para i= 0 Hasta 9 Con Paso 1 Hacer
		Si nombres[i] != "" y cantidad[i] > 0 Entonces
